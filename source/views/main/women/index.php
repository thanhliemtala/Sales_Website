...
<?php require_once("models/product.php"); 
    ...
    $totalProduct = count($women); // Tổng số sản phẩm
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-9 px-0" id="women-galery">
            <div class="container-fluid px-0 mx-0" id="product-container">
                ...
                <?php  
                    ...
                    echo  "<p class='card-text text-secondary women-type'>".$value->product_subcategory."</p>";
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                for ($page = 1; $page <= $totalPages; $page++) {
                    ...
                    echo '<li class="page-item ' . $isActive . '"><a class="page-link" href="?page=main&controller=women&action=index&product_page=' . $page . '">' . $page . '</a></li>';
                }
                ?>
            </ul>
        </nav>
